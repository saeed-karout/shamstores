...
export const PLAN_SEEDS: PlanSeed[] = [
      {
        ...
        maxMenuItems: 10,
        maxProducts: 10,
        // خمسة طلبات شهرياً للتجربة. صفرٌ كان يعني أن التاجر لا يرى مطلقاً
        // كيف يصله الطلب ولا كيف يديره — فيُطلب منه الدفع مقابل شيء لم
        // يجرّبه. والحدّ شهري لا تراكمي: راجع orderQuota.service.
        maxOrders: 5,
        isActive: true,
        position: 1,
        hasTableQr: true,
